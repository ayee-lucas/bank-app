...
export const NavBar = () => {
  ...
  return (
    <>
          ...
          <div className="min-h-[70px] flex flex-wrap items-center justify-between mx-auto p-2 px-6">
            ...
            <ul className="text-white flex flex-row font-medium bg-violet-800 dark:bg-violet-900 space-x-2 dark:border-gray-700 max-sm:hidden z-10">
              <li>
                <Link
                  href="/Home"
                  className="block py-2 pl-3 pr-4 rounded hover:text-gray-300"
                  aria-current="page"
                >
                  Home
                </Link>
              ...
              <li>
                <Link
                  href="/Home/Transfer"
                  className="block py-2 pl-3 pr-4 rounded hover:text-gray-300 md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Transfer
                </Link>
              </li>
      ...
      <div
        className={`fixed z-20 sm:hidden top-0 right-0 w-[50%] max-xsm:w-[70%] h-full transition duration-500 border-l border-violet-200 dark:border-zinc-800 
