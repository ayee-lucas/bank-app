export default async function AboutPage() {
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="p-7 text-3xl font-semibold text-violet-900 underline underline-offset-8">
        About
      </div>
        ...
        <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-4 font-medium text-gray-900 text-center">Options</th>
            </tr>
          </thead>
