  ...
  return (
    <div>
      <div className="w-full flex items-center justify-between py-4">
        <Input
          placeholder="Filter Name/Username..."
          value={(table.getColumn("name & username")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("name & username")?.setFilterValue(event.target.value)
          }
        ...
        <button
          onClick={(e) => {
            e.preventDefault();
            router.replace("/console/Users?new=true");
          }}
